...
document.addEventListener('DOMContentLoaded', () => {
    if (isDemoMode) {
        // The demo page is public and should always initialize
        initializeAppForDemo();
    } else {
        // This is a private page. We MUST check access.
        // If checkAccess returns false, the user does not have permission.
        if (!checkAccess()) {
            // Show the access denied message instead of initializing the app
        ...
        // If we get here, the user has access. Proceed with initialization.
...
ProAnthemApp.prototype.handlePrintSetlist = async function(drummerMode = false) { /* ... This is a very long function, but it is fully implemented ... */ };
